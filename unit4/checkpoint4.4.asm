...
//Checkpoint: 4.4 Implement a SYSCALL that sends data to the Operating System   
//Unit Purpose: 
...
//Description: 
//             Implement an API with a function print_string(char *string) that calls SYSCALL$02 that allows user program to print a string on the screen. (myabi.kc)  
//             On SYSCALL02 function needs to fix the memory area where the data transfer is going use the recommended area is from $0300 to $03FF.
//             
//******************************
...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  //char[] MESSAGE = "checkpoint 4.4  gall0165";
  lda #<0
...
RESET: {
    ...
    rts
  .segment Data
    message: .text "checkpoint 4.4 gall0165"
    .byte 0
}
.segment Code
