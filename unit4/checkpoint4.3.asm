...
//             Also in this checkpoint there is going to create a file that tells the MEGA65 to allow system calls to be made (myabi.kc)
//             An create an API that wraps the SYSCALL ABI for SYSCALL00 and SYSCALL01 (userspace4.3.kc) import the myabi.kc file
//******************************
...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  //char[] MESSAGE = "checkpoint 4.3  gall0165";
  lda #<0
...
RESET: {
    ...
    rts
  .segment Data
    message: .text "checkpoint 4.3 gall0165"
    .byte 0
}
.segment Code
